        ...
        <div class="profile-image">
            <div class="dashboard">
                <div class="container-profile">
                    @if($image->user->image)
                        <img src="{{ url('/user/avatar/'.$image->user->image) }}" class="avatar-pro">
                    @else
                        <img src="https://grandimageinc.com/wp-content/uploads/2015/09/icon-user-default.png" class="avatar-dashboard">
                    @endif
                            
                    <a href="{{ route('profile', ['id' => $image->user->id]) }}" class="names-profile"> 
            ...
            <div class="bg-white border-b border-gray-200">
                <img src="{{ route('image.file', ['filename' => $image->image_path]) }}" class="image-pro">
            </div>
            <div class="like">
                <?php $user_like = false; ?>
            ...
            <div class="form-comment-dashboard">
                <form method="POST" action="{{ route('comment.save') }}">
                    ...
                    <p>
                        <textarea class="comment-profile" name="content"></textarea>
                    ...
                    <button class="btn-profile">Publicar</button>
                </form>
            </div>                
        </div>
    </div>
